...
const ThreadsModal = ({ showModal }) => {
  ...
  return (
    <div className='ThreadsModal'>
      <div
        className='ThreadsModal-background'
        ref={background}
        onClick={(e) => {
          if (background.current === e.target) overflow();
        }}
      >
        <div className='ThreadsModal-container'>
          <div className='top'>
          ...
          <div className='ThreadsModal-content'>
            <div>
